...
<table width="1014" border="0" id="tabel">
  ...
  <tr>
    ...
    <td height="24">&nbsp;</td>
    <td width="571" rowspan="14" align="center" valign="top" ><table width="555" border="0">
      <tr>
        <td height="29" colspan="4" align="center" bgcolor="#0000FF"><strong>Buku Terbaru</strong></td>
        </tr>
      <tr>
        <td width="176" height="28" align="center" bgcolor="#CCCCCC">sampul</td>
        <td width="196" align="center" bgcolor="#CCCCCC">judul</td>
...
?>   
      ...
      <tr>
        <td height="100" align="center" valign="middle"><img src="<?php echo $data['gambar']; ?>" border="0" width="130" height="160"/></td>
        <td align="center" valign="middle"><?php echo $data['nama']; ?></td>
        <td width="103" align="center" valign="middle"> <?php echo $data['harga'] ?> </td>
        <td width="62" align="center" valign="middle">
          <input type="submit" name="beli" id="beli" value="beli">
       </td>
      </tr>
      <?php  $no++; } ?> 
      <?php } ?>
