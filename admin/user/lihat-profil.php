...
?> 
    ...
    <td height="33">&nbsp;</td>
    <td width="556" rowspan="14" align="center" valign="top" ><table width="549" height="466" border="0">
      <tr>
...
?>      
        ...
        <td height="29" colspan="3" align="center"><strong>- - - Lihat Profil- - -</strong></td>
        </tr>
      <tr>
        <td height="25" colspan="3" bgcolor="#CCCCCC"><strong>Data Pribadi</strong></td>
        </tr>
      <tr>
        <td width="171" height="35">Nama</td>
        <td width="22" align="center"><strong>:</strong></td>
        <td width="342"><?php echo $data['nama']; ?></td>
      </tr>
      <tr>
        <td height="94" valign="top">Alamat</td>
        <td align="center" valign="top"><strong>:</strong></td>
        <td valign="top"><?php echo $data['alamat']; ?></td>
      </tr>
      <tr>
        <td height="36">Provinsi</td>
      ...
      <tr>
        ...
        <td align="center"><strong>:</strong></td>
        <td valign="middle"><?php echo $data['jenis_kelamin']; ?></td>
      </tr>
      <tr>
        <td height="33">Telepon</td>
        <td align="center"><strong>:</strong></td>
      ...
      <tr>
        ...
        <td><strong><a href="edit-user.php? id=<?php echo $data['id_pelanggan']?>">--- Edit Profil --</a></strong></td>
      </tr>
    </table></td>
    <td>&nbsp;</td>
