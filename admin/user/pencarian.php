...
<table width="1014" border="0" id="tabel">
  ...
  <tr>
    <td height="26" colspan="5" align="center" bgcolor="#0066FF"><strong>--- Hasi Pencarian ---</strong></td>
    </tr>
  <tr>
...
$no=1;
$cari=$_POST['cari'];
$tampil=mysql_query("select * from barang where nama like '%$cari%' or pengarang like '%$cari%'");
...
?>
      ...
      <tr>
        <td height="24" align="center"><strong><a href="aksi-keranjang.php?id=<?php echo $data['id_buku']; ?> ">BELI</a></strong></td>
        <td align="center"><strong>BELI</strong></td>
        <td align="center"><strong>BELI</strong></td>
      </tr>
