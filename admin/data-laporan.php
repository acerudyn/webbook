...
<table width="1006" height="448" border="0"  bordercolor="#FFFFFF" id="tabel" align="center">
  <tr>
    ...
    <td colspan="2" rowspan="15" align="right" valign="top"><table width="810" border="0">
      ...
      <tr>
        <td height="27" colspan="3" align="center" bgcolor="#000000"><strong>Menu Laporan</strong></td>
        </tr>
      <tr>
        <td width="161" height="27" align="center" bgcolor="#CCCCCC">Lapon Produk</td>
        <td width="183" height="27" align="center" bgcolor="#CCCCCC">Laporan Member</td>
        <td width="182" height="27" align="center" bgcolor="#CCCCCC">Laporan Penjualan</td>
      </tr>
      <tr>
        <td height="27">&nbsp;</td>
        <td height="27">&nbsp;</td>
