...
<table width="1006" height="448" border="0"  bordercolor="#FFFFFF" id="tabel" align="center">
  <tr>
    <td height="7">&nbsp;</td>
    <td colspan="2" rowspan="15" align="right" valign="top"><table width="805" height="111" border="0">
      <tr>
        <td height="7" colspan="5">&nbsp;</td>
        </tr>
      <tr>
        <td height="27" colspan="5" align="center" bgcolor="#000000"><strong>Tambah Data Provinsi</strong></td>
        </tr>
      <tr>
        <td height="27" align="center" bgcolor="#CCCCCC">ID Provinsi</td>
        <td height="27" align="center" bgcolor="#CCCCCC">Jasa Pengiriman</td>
        <td height="27" align="center" bgcolor="#CCCCCC">Provinsi</td>
